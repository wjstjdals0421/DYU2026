const worksDataset = [
    ...
    { id: 'V_M_1', category: 'Visual', designer: 'M', engName: 'M', title: '작품명 입력 M-1', desc: 'M 학생의 첫 번째 작품 설명입니다.', thumbFile: 'pc_M_p1.png', detailPrefix: 'pe_M_p1', imagesCount: 2, email: '이메일 입력', insta: '@인스타 입력' },
...
function initPhysics() {
    ...
    // 모바일 기기 성능 최적화를 위해 반복 연산 횟수 최적화 (30 -> 10)
